...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1>Cetak <small>Voucher Internet</small></h1>
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><i class="fa fa-file"></i> Voucher</li>
        <li><i class="fa fa-user"></i> Kursus</li>
        <li class="active"><i class="fa fa-print"></i> Cetak Voucher Internet</li>
      </ol>
    </div>
  </div><!-- /.row -->
  <!-- voucher internet-->
                ...
                <div class="voucher">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-7">
                        <h5 class="text-left"><strong>Voucher Internet</strong> bernilai <strong>50%</strong></h5>
                        <p class="text-left">Berlaku untuk 1 orang untuk penggunaan minimal 2 jam.</p>
